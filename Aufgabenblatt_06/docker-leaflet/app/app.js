...
//var apiHost =  'http://141.22.102.166:8022';
//var apiHost =  'http://141.22.103.237:8032';
...
directionControl.onAdd = function (map) {
	...
	div.innerHTML = '<form><input type="checkbox" id="myCheckbox"/>Use PLZ_From</form>';
        return div;
	console.log(div);
};
...
info1.update = function (props, ShipmentIds, topplz) {
		this._div.innerHTML = (props ? '<p><b>Newest 25 Shipment IDs </b></p>'
			+ShipmentIds + '<br/>' + topplz
			: '<p><b>Additional Information </b></p>' + 'Hover over a district');};
