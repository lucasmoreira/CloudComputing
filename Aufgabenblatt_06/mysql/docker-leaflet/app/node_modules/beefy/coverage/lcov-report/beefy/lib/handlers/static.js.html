...
<html lang="en">
<head>
    <title>Code coverage report for beefy/lib/handlers/static.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">beefy/lib/handlers/static.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">beefy/lib/handlers/</a> &#187; static.js</div>
</div>
<div class="body">
...
function handleStatic(opts, io, nextHandler) {
  var cwd = opts.cwd || <span class="branch-1 cbranch-no" title="branch not covered" >process.cwd()</span>
&nbsp;
  return handle
&nbsp;
